...
@EXPORT = ('MENU_TITLE', 'MENU_SUBTITLE', 'MENU_FILE', 'MENU_GROUP', 'MENU_TEXT', 'MENU_LINK', 'MENU_FOOTER',
                   ...
                   'AUX_FRAGMENT', 'AUX_IMAGE',                         #ND+, package
                   'SUMMARIES_NO', 'SUMMARIES_YES', 'SUMMARIES_ONLY');  #ND+, package/summaries
...
#ND+, package
#                                                       
#   Constants: Auxiliary content types
#
#   Used as the HasContent() setting of auxillary files
#
#       AUX_FRAGMENT -          Generated fragment of a package split.
#       AUX_IMAGE -             Imported image.
#
#   Dependencies:
#
#       - All must be negative values, as this is used to key whether the file
#       is a primary source or auxillary file image.
#
use constant AUX_FRAGMENT => -1;
use constant AUX_IMAGE => -2;


#ND+, package/summaries
#                                                              
#   Constants: Summaries status
#
#   Used as the HasContent() setting of auxillary files
#
#       SUMMARIES_NO -          Do not generate a summary, only a body.
#       SUMMARIES_YES -         Yes generated a summary plus a topic body.
#       SUMMARIES_ONLY -        Only generated a summary, not a topic body.
#
use constant SUMMARIES_NO => 0;
use constant SUMMARIES_YES => 1;
use constant SUMMARIES_ONLY => 2;
